...
#define NRA 700         /* number of rows in matrix A */ 
#define NCA 700         /* number of cols in matrix A */ 
#define NCB 700          /* number of cols in matrix B */ 
